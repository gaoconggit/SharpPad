...
RUN dotnet build "./SharpPad.csproj" -c $BUILD_CONFIGURATION -o /app/build

# 此阶段用于发布要复制到最终阶段的服务项目
FROM build AS publish
ARG BUILD_CONFIGURATION=Release
RUN dotnet publish "./SharpPad.csproj" -c $BUILD_CONFIGURATION -o /app/publish /p:UseAppHost=false
