...
namespace System
{
    public static class ObjectExtension
    {
        ...
        public static string ToJson(object value, bool format)
        {
        ...
        public static void Dump(object value, string description)
        {
            Dump(value, description, 3);
        }

        public static void Dump(object value, string description, int maxDepth)
        {
